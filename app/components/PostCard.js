...
const PostCard = () => {
	...
	console.log('posts: ', session.user.posts);

	return (
		<>
			{session.user.posts.map((post) => (
				<div className="rounded-b-md w-min-fit" key={post.id}>
							...
							<div>
								<div className="bg-gray-100 p-3 rounded-2xl w-[380px]">
									...
									<div className="text-md leading-5 text-gray-700">
										...
										pocket and the whole case fell out . I couldnU+2019t track
										them but hopefully someone gets these back
									</div>
								</div>
							</div>
						</div>
